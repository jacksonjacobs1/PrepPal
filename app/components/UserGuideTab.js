  ...
  return (
    <ScrollView testID='userGuideTab'>
      ...
      <Text>
        ...
        click the "New Recipe" button on the taskbar to let the program know what ingredients you have on hand. We will then look for recipes online and give you the option to
